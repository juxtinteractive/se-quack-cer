...
class Blob {
  ...
  // Make me
  Blob(PApplet parent, int id, Contour c, boolean isbill) {
    this.parent = parent;
    this.id = id;
  ...
  void display() {
    ...
    fill(isBill?0:255,0,isBill?255:0,opacity);
    stroke(isBill?0:255,0,isBill?255:0);
  ...
  public PVector getCenter(){
    ...
    return new PVector((float)(r.getCenterX()),(float)(r.getCenterY())); 
  }
}
